...
1. Overall medals (gold, silver, and bronze) won by Olympians
...
2. Olympic medal winning women's heights and weights
...
golden_girls %>% 
  ...
  geom_point() + 
  labs(title = "Bodytypes of Olympic Medal Winning Female Athletes",
    y = "Height (cm)",
       x = "Weight (kg)") 
```
