...
```{r, fig.height = 3, fig.width = 5, fig.alt= "This graph shows the heights and weights of women who competed in the Olympics and won a medal."}
golden_girls %>% 
...
```{r, fig.height= 7 fig.alt= "This is a series of graphs that filter out sports into four distinct categories: "Holding an object," "Wearing protective gear," "In water," and "Just self." "}
fig1 <- equip_gg %>% 
  ggplot(aes(x = weight, y = height, color = sport)) +
  geom_point() 
